	...
	<body>
		...
		<div class="student_profile">
			...
			<table>
				...
				<tr class = "zebra">
					<td><i>Programme</i></td>
					<td><?php echo $Programme?>placeholder</td>
					<td>N/A</td>
					<td>N/A</td>
				</tr>
				<tr class = "zebra">
					<td><i>Gender</i></td>
					<td><?php echo $Gender?>placeholder</td>
					<td>N/A</td>
					<td>N/A</td>
				</tr>
				<!-- DSE Results -->
				...
				<tr class = "zebra">
					<td><i>P Score</i></td>
					<td><?php echo $P_Score?>placeholder</td>
					<td>15.66</td>
					<td>14.00</td>
				</tr>
				<tr class = "zebra">
					<td><i>English</i></td>
					<td><?php echo $English?>placeholder</td>
					<td>2.70</td>
					<td>2.00</td>
				</tr>
				<tr class = "zebra">
					<td><i>Chinese</i></td>
					<td><?php echo $Chinese?>placeholder</td>
					<td>2.89</td>
					<td>2.00</td>
				</tr>
				<tr class = "zebra">
					<td><i>Mathematics</i></td>
					<td><?php echo $Mathematics?>placeholder</td>
					<td>3.18</td>
					<td>3.00</td>
				</tr>
				<tr class = "zebra">
					<td><i>Mathematics Statistics</i></td>
					<td><?php echo $Mathematics_Statistics?>placeholder</td>
					<td>0.14</td>
					<td>0.00</td>
				</tr>
				<tr class = "zebra">
					<td><i>Mathematics Algebra</i></td>
					<td><?php echo $Mathematics_Algebra?>placeholder</td>
					<td>0.37</td>
					<td>0.00</td>
				</tr>
				<tr class = "zebra">
					<td><i>Liberal Studies</i></td>
					<td><?php echo $Liberal_Studies?>placeholder</td>
					<td>3.15</td>
					<td>3.00</td>
				</tr>
				<!-- Holland Code (0 - 3) -->
				...
				<tr class = "zebra">
					...
					<td><?php echo $Realistic?>placeholder</td>
					<td>2.10</td>
					<td>2.00</td>
				</tr>
				<tr class = "zebra">
					<td><i>Investigative (I)</i></td>
					<td><?php echo $Investigative?>placeholder</td>
					<td>2.35</td>
					<td>2.00</td>
				</tr>
				<tr class = "zebra">
					<td><i>Artistic (A)</i></td>
					<td><?php echo $Artistic?>placeholder</td>
					<td>1.94</td>
					<td>1.00</td>
				</tr>
				<tr class = "zebra">
					<td><i>Social (S)</i></td>
					<td><?php echo $Social?>placeholder</td>
					<td>2.37</td>
					<td>2.00</td>
				</tr>
				<tr class = "zebra">
					<td><i>Enterprising (E)</i></td>
					<td><?php echo $Enterprising?>placeholder</td>
					<td>1.89</td>
					<td>1.00</td>
				</tr>
				<tr class = "zebra">
					<td><i>Conventional</i></td>
					<td><?php echo $Conventional?>placeholder</td>
					<td>2.39</td>
					<td>2.00</td>
				</tr>
				<!-- SDAS (1 - 5) -->
				...
				<tr class = "zebra">
					...
					<td><?php echo $Lifelong_Learner?>placeholder</td>
					<td>3.50</td>
					<td>3.00</td>
				</tr>
				<tr class = "zebra">
					<td>Competent (Associate) Professional Average</td>
					<td><?php echo $Competent?>placeholder</td>
					<td>3.96</td>
					<td>3.67</td>
				</tr>
				<tr class = "zebra">
					<td>Critical Thinker Average</td>
					<td><?php echo $Critical_Thinker?>placeholder</td>
					<td>3.47</td>
					<td>3.00</td>
				</tr>
				<tr class = "zebra">
					<td>Effective Communicator Average</td>
					<td><?php echo $Effective_Communicator?>placeholder</td>
					<td>3.78</td>
					<td>3.33</td>
				</tr>
				<tr class = "zebra">
					<td>Problem Solver Average</td>
					<td><?php echo $Problem_Solver?>placeholder</td>
					<td>3.73</td>
					<td>3.33</td>
				</tr>
				<tr class = "zebra">
					<td>Ethical Citizen Average</td>
					<td><?php echo $Ethical_Citizen?>placeholder</td>
					<td>3.88</td>
					<td>3.67</td>
				</tr>
				<tr class = "zebra">
					<td>Global Awareness Average</td>
					<td><?php echo $Global_Awareness?>placeholder</td>
					<td>3.39</td>
					<td>3.00</td>
				</tr>
			</table>
